...
public class _10_WindowHandles extends Base{
    ...
    */
    ...
    public void testWindowHandle2(){
        ...
        heroAppPage.clickHereMultipleWindows.click();
        ...
        Assert.assertEquals(heroAppPage.getMultipleWindowsHeader3.getText(), "New Window");
        driver.switchTo().window(mainWindow);
        Assert.assertEquals(heroAppPage.OpenNewWindowHeader3.getText(), "Opening a new window");
