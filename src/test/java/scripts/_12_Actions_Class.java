...
public class _12_Actions_Class extends Base{
    ...
    public void clickOnElementPractice(){
        ...
        WebElement introSession = driver.findElement(By.cssSelector("#comp-kuiqjiul1label"));
        actions.click(introSession).perform();
    ...
    public void rightClickPractice(){
        ...
        WebElement introSession = driver.findElement(By.cssSelector("#comp-kuiqjiul1label"));
        actions.contextClick(introSession).perform();
    ...
    public void etsyTest(){
       ...
       String [] jewelryAndAccessoryList = {"Accessories",
               "Bags & Purses",
               "Necklaces",
               "Rings",
               "Earrings",
        ...
        for (int i = 0; i < 8; i++) {
            Waiter.waitUntilTextToBePresentInElement(driver, 30, etsySearchPage.jewelryAndAccessoriesItems.get(i), jewelryAndAccessoryList[i]);
            Assert.assertEquals(etsySearchPage.jewelryAndAccessoriesItems.get(i).getText(), jewelryAndAccessoryList[i]);
        }
